...
public class CategoryApiController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody CategoryUpdateRequestDto categoryUpdateRequestDto, BindingResult bindingResult) {
        if(bindingResult.hasErrors() || !categoryService.isOwner(id))
            return new ResponseEntity<>("잘못된 요청입니다", HttpStatus.BAD_REQUEST);
